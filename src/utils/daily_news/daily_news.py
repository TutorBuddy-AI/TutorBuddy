...
class DailyNew:
    def __init__(self):
        ...
    @Transactional()
    async def add_news(self, topic: str, message: str, new_types: DailyNewsEnum.NEWS_TYPE__TEXT, path_to_data: str) -> None:
    ...
    async def get_daily_news(
        ...
        results = [{'topic': row.topic, 'content': row.message} for row in result]
        return results
