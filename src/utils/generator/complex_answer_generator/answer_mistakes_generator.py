...
from src.utils.generator.complex_answer_generator.answer_schema import answer_schema
    ...
    async def get_user_message_history_with_service_text_request_and_prompt(self) -> GetUserMessageHistory:
        ...
        answer_request = {
            ...
            "content": """
                    ...
                    as if you're chatting with a friend to keep the conversation going. Always conclude your responses 
                    with a relevant question to ensure the conversation continues on an engaging note. 
