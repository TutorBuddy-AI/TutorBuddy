function searchMessages() {
        ...
        t = function(e, t) {
            ...
            if (null !== e) {
                ...
                try {
                    ...
                    // Продолжаем добавлять логирование к другим обработчикам
                    S();
                    w();
                    ...
                    t.forEach(function(t) {
                        t.addEventListener("click", function() {
                            ...
                            var e = t.closest(".ctext-wrap").children[0].children[0].innerText,
                                ...
                                e = !t.closest(".chat-list") || т.closest(".chat-list").classList.contains("left") ? e : "You";
                            document.querySelector(".replyCard .replymessage-block .flex-grow-1 .conversation-name").innerText = e;
    ...
    e("chat-users-list.json", function(e, t) {
        null !== e ? console.log() : (t[0].users.forEach(function(e, t) {
        ...
        var n, a;
        null !== e ? console.log() : ((d = t).sort(function(e, t) {
