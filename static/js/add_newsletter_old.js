        ...
        const imageInput = document.getElementById('image');
            ...
            if (imageInput.files.length > 0) {
                ...
                reader.onload = async function (e) {
                    ...
                    const urls = ['https://admin.tutorbuddyai.tech/aa_lingua/save-newsletter','https://admin.tutorbuddyai.tech/original/save-newsletter', 'https://admin.tutorbuddyai.tech/oksana/save-newsletter', 'https://admin.tutorbuddyai.tech/victoria/save-newsletter']
